...
template <typename K, typename V>
void stringTestRoutine(HashTable<K, V>& HashTable, int elements, std::ofstream& file_hash, std::ofstream& file_op, bool mode = true) {
...
void stringTest(int elements, std::pair<std::ofstream, std::ofstream>& files, int load_factor = 0) {
    ...
    */
    {
        ...
        stringTestRoutine(HashTable, elements, files.first, files.second);
    }
    {
        std::cout << "-----------------------------" <<std::endl;
        std::cout << "HashTable:" << std::endl;
        ...
        HashTable<std::string, std::string> HashTable(OVERFLOW::OPEN_ADDRESSING_LINEAR_PROBING, HASH::MODE_1, RESIZE::DOUBLE, 256, linear_load_factor);
        stringTestRoutine(HashTable, elements, files.first, files.second, false);
    }
    /*
    * HashTable:
    *   OVERFLOW::OPEN_ADDRESSING_LINEAR_PROBING
...
int main() {
    ...
    for(int x=0; x<5; x++) {
        ...
        for(int i=0; i<5; i++) {
            ...
            std::cout << "-----------------------------" <<std::endl;
            stringTest(base_length * std::pow(2, i), files);
        }
        ...
        for(int i=0; i<5; i++) {
            ...
            std::cout << "ELEMENT COUNT: " << (base_length * std::pow(2, i)) <<std::endl;
            std::cout << "-----------------------------" <<std::endl;
            stringTest(base_length * std::pow(2, i), files, 1);
        }
        ...
        for(int i=0; i<5; i++) {
            ...
            std::cout << "ELEMENT COUNT: " << (base_length * std::pow(2, i)) <<std::endl;
            std::cout << "-----------------------------" <<std::endl;
            stringTest(base_length * std::pow(2, i), files, 2);
        }
    }
